    ...
    for epoch in range(epochs):
        for phase in ['train', 'valid']:
            ...
            for step, (inputs, labels) in enumerate(image_dataset[phase]):
                ...
                #if running_samples>(0.20*len(image_dataset[phase].dataset)):
                #    break
...
def main(args):
    ...
    model=train(model, train_loader, validation_loader, loss_criterion, optimizer, args.epochs, hook, device)    
